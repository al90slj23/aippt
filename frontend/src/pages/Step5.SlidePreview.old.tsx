...
import { Button, Loading, Modal, Textarea, useToast, useConfirm, MaterialSelector, ProjectSettingsModal, ExportTasksPanel, ProgressSteps, StepLayout, ActionButton } from '@/components/shared';
...
export const Step5SlidePreview: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
      ...
      {/* 主内容区 */}
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden min-w-0 min-h-0 pb-28 md:pb-32">
        {/* 左侧：缩略图列表 */}
